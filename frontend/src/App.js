  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-green-50 to-teal-50">
      ...
      <header className="w-full py-6">
        <h1 className="text-center text-4xl font-thin text-gray-800 flex items-center justify-center gap-2">
              ...
              <Card>
                ...
                <div className="px-6 pb-6 space-y-3 text-sm text-gray-600">
                  <div className="space-y-2">
                    <p className="font-medium text-gray-800">1. Smart Algorithm</p>
                  ...
                  <Separator />
                  <div className="space-y-2">
                    <p className="font-medium text-gray-800">2. Click & Explore</p>
                    <p>Click on any ⭐ optimal location to see detailed analysis including cost projections and infrastructure proximity.</p>
                  </div>
                  <Separator />
                  <div className="space-y-2">
                    <p className="font-medium text-gray-800">3. Data-Driven Decisions</p>
              ...
              <Card className="h-fit">
                ...
                <div className="px-6 pb-6">
                  <div className="text-center py-8 space-y-4">
                    ...
                    <div className="space-y-2">
                      <p className="font-medium text-gray-600">Select an Optimal Location</p>
                      <p className="text-sm text-gray-500">Click on any ⭐ marker to view detailed analysis and investment recommendations</p>
                    </div>
                  </div>
                </div>
              </Card>
