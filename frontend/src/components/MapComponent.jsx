...
const MapComponent = ({
  ...
  const calculateResourceRadii = (optimalLocation) => {
    ...
    setResourceRadii({
      energy:
        maxEnergyDistance > 0 ? Math.max(maxEnergyDistance * 1000, 5000) : null,
      demand:
        maxDemandDistance > 0 ? Math.max(maxDemandDistance * 1000, 5000) : null,
      water:
        maxWaterDistance > 0 ? Math.max(maxWaterDistance * 1000, 5000) : null,
    });
  };

  const handleOptimalLocationClick = useCallback(
    (location) => {
    ...
    <div className="h-full w-full relative">
      ...
      >
              ...
              <div className="p-2 min-w-[200px]">
                ...
                <div className="space-y-1 mt-2">
                  ...
                  <p className="text-sm text-gray-600">
                    Capacity: {source.capacity_mw} MW
                  </p>
                  <p className="text-sm text-gray-600">
                    Cost: ₹{source.cost_per_kwh}/kWh
                  </p>
                  <p className="text-sm text-gray-600">
                    Generation: {source.annual_generation_gwh} GWh/year
                  </p>
            ...
            popupContent={
              <div className="p-2 min-w-[200px]">
                ...
                <div className="space-y-1 mt-2">
                  ...
                  <p className="text-sm text-gray-600">
                    H₂ Demand: {center.hydrogen_demand_mt_year.toLocaleString()}{" "}
                    MT/year
                  </p>
                  <p className="text-sm text-gray-600">
            ...
            popupContent={
              <div className="p-2 min-w-[200px]">
                ...
                <div className="space-y-1 mt-2">
                  ...
                  <p className="text-sm text-gray-600">
                    Quality Score: {water.quality_score}/10
                  </p>
                  <p className="text-sm text-gray-600">
                  ...
                  <p className="text-xs text-gray-500">
                    Clearance:{" "}
                    {water.regulatory_clearance ? "Approved" : "Pending"}
                  </p>
                </div>
              </div>
            }
            ...
            <Popup>
              <div className="p-2 min-w-[200px]">
                ...
                <div className="space-y-1 mt-2">
                  ...
                  <p className="text-sm text-gray-600">
                    Area: {body.area_sq_km} km²
                  </p>
                  <p className="text-sm text-gray-600">
                    Depth: {body.depth_meters}m
                  </p>
                  <p className="text-sm text-gray-600">
                    Quality: {body.water_quality}
                  </p>
                  <p className="text-xs text-gray-500">
                    Access:{" "}
                    {body.access_permission ? "Permitted" : "Restricted"}
                  </p>
                </div>
              </div>
            </Popup>
              ...
              <div className="p-3 min-w-[220px]">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-medium">
                      {location.production_metrics?.annual_capacity_mt.toLocaleString()}{" "}
                      MT/year
                    </span>
                  </div>
                </div>
                <Button
                  ...
                  onClick={() =>
                    onViewFullAnalysis
                      ? onViewFullAnalysis(location)
                      : handleOptimalLocationClick(location)
                  }
                >
        ...
        {selectedOptimalLocation && resourceRadii.energy && (
          <Circle
            center={[
              selectedOptimalLocation.location.latitude,
              selectedOptimalLocation.location.longitude,
            ]}
